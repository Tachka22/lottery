...
public class EmailSender implements NotificationSender {
    ...
    public void send(NotificationEvent event) {
        executor.submit(() -> {
            try {
                ...
                log.error("Не удалось отправить email на {}", event.recipient(), e);
            }
        });
    }
    ...
    private void sendSync(NotificationEvent event) {
        ...
        try {
            ...
            throw new RuntimeException("Ошибка при отправке email на " + event.recipient(), e);
        }
    }
    ...
    private void validateRecipient(String email) {
        try {
            ...
            throw new IllegalArgumentException("Некорректный email адрес: " + email, e);
        }
    }
